...
class MyLoop(loopmodel):
    ...
    def select_loop_atoms(self):
        ...
        return selection(self.residue_range('409:A', '435:A'), self.residue_range('818:B', '845:B'), self.residue_range('889:B', '900:B'), self.residue_range('1173:B', '1202:B'), self.residue_range('1450:B', '1480:B'))
